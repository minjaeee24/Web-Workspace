...
<body>
	<h3>1. 기존 방식대로 스크립틀릿과 표현식을 이용해서 각 영역에 담겨있는 값을 뽑아서 화면에 출력하기</h3>
	<%
	...
	<p>
		EL은 getXXX를 통해 값을 빼올 필요 없이 키값만 제시하면 바로 접근이 가능하다 <br>
	...
	<p>
		...
		<%-- 
			...
			★내부적으로 해당 필드의 getter메소드를 찾아서 실행하는 구조(getter메소드가 없다면 실행이 안 됨)
		 --%>
		 <ul>
	...
	<!-- 
		...
		현재 찾고 있는 scope범위 안에서 내가 찾고자 하는 속성이(키값이) 존재한다면, 반복을 멈추고 해당 속성의 속성값을 출력함 
