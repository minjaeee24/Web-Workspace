...
public class BoardDao {
	...
	public ArrayList<Board> selectList(Connection conn, PageInfo pi){
		...
		try {
			 ...
			 * currentPage n을 요청시 -> 시작값 : (currnetPage - 1) * boardLimit + 1 ~ 시작값 + boardLimit - 1
			 * 
			 * 
			 */
	...
	public Board thumbnailDetailBoard(Connection conn, int boardNo) {
	...
	public ArrayList<Board> searchList(Connection conn, String searchType, String keyword){
		...
		// 지금은 searchType값을 하드코딩해두었지만 사용자의 요청방법에 맞게끔
		// 변경도 가능해야한다.
