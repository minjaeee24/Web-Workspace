...
<body>
	...
	<div class="login-area">
		...
		<form id="login-form" action="/jspproject/login.me" method="">
			<table>
				<tr>
					<th>아이디 : </th>
	...
	<div class="nav-area" align="center">
		...
		<div class="menu"><a href="<%= contextPath%>/list.do?currnetPage">일반게시판</a></div>
		<div class="menu"><a href="<%= contextPath%>/list/thp">사진게시판</a></div>
